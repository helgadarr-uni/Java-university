...
public class SalonPriceServiceTest {
    ...
    public static void beforeClass() {
        ...
        salon = new Salon.Builder().setId(122).setAddress("Komarova str").setPhoneNumber("0(950)234867").build();
        salon.setCars(List.of(car90000, car80000, car70000, car100000));
    }
    ...
    public void testLowerPriceASC() {
        ...
        expected.add(car90000);
        SalonPriceService sortService = new SalonPriceService(salon);
        Set<Car> actual = sortService.belowPrice(90000, SORT.ASC);
        Assert.assertEquals(expected.toString(), actual.toString());
    }
    ...
    public void testLowerPriceDSC() {
        ...
        expected.add(car70000);
        SalonPriceService sortService = new SalonPriceService(salon);
        Set<Car> actual = sortService.belowPrice(90000, SORT.DSC);
        Assert.assertEquals(expected.toString(), actual.toString());
    }
