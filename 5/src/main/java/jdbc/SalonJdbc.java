...
public class SalonJdbc {
    //буду використовувати в dao
    Connection connection;

    public SalonJdbc() throws IOException {
        Properties properties = new Properties();
        properties.load(new FileReader("lab0/src/main/resources/app.properties"));
        try {
    ...
    public Boolean createSalon() throws SQLException {
        // тут зразу викличу поле конекшн
    ...
    public Boolean createCar() throws SQLException, IOException {
    ...
    public void dropSalon() throws SQLException, IOException {
        Statement statement = connection.createStatement();
